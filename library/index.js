console.log(`Привет, мой проверяющий! Я очень старался делать сделать это задание и рассчитываю на максимальный балл. Если нашел какие-то ошибки - буду рад обратной связи.
