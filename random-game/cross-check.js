...
Не реализована таблица с 10ю лучшими результатами, но отображается лучший результат (также хранится в локал сторадж), компенсировать эти 10 баллов планировал с помощью последнего пункта.
Вёрстка +10
